...
public class GoogleBooksMock extends GoogleBooks{
    ...
    static final String URL_JAVA_DESIGN_ISBN = "https://www.googleapis.com/books/v1/volumes?q=isbn=9780201485394";
    static final String URL_JAVA_DESIGN_TITLE = "https://www.googleapis.com/books/v1/volumes?q=Java+Design+Patterns";
    static final String FILE_JAVA_DESIGN = "src\\test\\resources\\GoogleBooks\\Google_java_design_patterns.json";
